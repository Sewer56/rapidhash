...
pub fn bench(c: &mut Criterion) {
    let groups: &[(
        ...
        ("hash/xxhash64", Box::new(vector::bench_xxhash64), Box::new(int::bench_xxhash64), Box::new(object::bench_xxhash64)),
        ("hash/xxhash3_64", Box::new(vector::bench_xxhash3_64), Box::new(int::bench_xxhash3_64), Box::new(object::bench_xxhash3_64)),
